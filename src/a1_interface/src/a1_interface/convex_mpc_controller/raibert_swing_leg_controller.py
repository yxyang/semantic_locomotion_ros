...
from a1_interface.convex_mpc_controller import gait_generator as gait_generator_lib
...
def cubic_bezier(x0: np.ndarray, x1: np.ndarray, t: float) -> Sequence[float]:
