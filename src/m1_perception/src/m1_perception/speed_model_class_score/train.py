...
from m1_perception.speed_model_class_score import data_loader
from m1_perception.speed_model_class_score.model import SpeedModel
from m1_perception.speed_model_class_score import mask_utils
...
flags.DEFINE_string(
    'val_data_dir',
    'm1_perception/speed_model/data/ghost_memory_taylor_demo2/val',
